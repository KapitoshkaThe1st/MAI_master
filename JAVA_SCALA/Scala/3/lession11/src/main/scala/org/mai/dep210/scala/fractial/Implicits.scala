package org.mai.dep210.scala.fractial
...
case class Fractional[A: Arithmetic](numerator: A, denominator: A) {
  ...
  println(numerator.getClass.getName)
  println(denominator.getClass.getName)
